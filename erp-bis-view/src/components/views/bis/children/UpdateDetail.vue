  ...
  <div id="UpdateDetail">
    ...
    <div class="pTop">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item :to="{ path: '/SystemUpdate' }">系统更新</el-breadcrumb-item>
        <el-breadcrumb-item>更新详情</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- 表头 -->
    <div class="col-nav" style="margin:10px 0;">
     <span style="margin-left: 20px">{{this.sysNotiTheme}}</span>
    </div>
    <div>
      <span style="margin-left: 20px">{{this.sysNotiContent}}</span>
    </div>
    <!--footer-->
    <div class="wmsFoot">
