    ...
    <div class="pDown">
      <el-table :data="tableData"
        ...
        <el-table-column label="操作"  width="160" align='center'>
          <template slot-scope="scope">
            <div>
              <el-button @click="" type="text" size="small">编 辑</el-button>
              <el-button @click="" ref="del" type="text" size="small" style="color: red">删 除</el-button>
              <el-button @click="history()" type="text" size="small">历史记录</el-button>
            </div>
          </template>
        </el-table-column>
