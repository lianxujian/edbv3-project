...
<template>
  <div id="singleSku">
    <div id="searchBox">
      ...
      <div class="rightBox2">
        <el-button class="el-buttonOne" @click="initMessage()" style="width:50px" type="primary" >查 询</el-button>
        <el-button class="el-buttonOne" @click="reset" size="mini" type="default">重 置</el-button>
        <el-button class="el-buttonOne1" @click="query()" size="mini" type="primary" >高级查询</el-button>
      </div>
    </div>
