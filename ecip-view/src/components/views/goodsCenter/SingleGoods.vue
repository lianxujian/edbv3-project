...
<template>
  <div id="singleGoods">
    <div id="searchBox">
      <div class="leftBox2">
        ...
        <el-col :span="5">
          <div class="grid-content" >
            <label>分类：</label>
            <el-select id="searchStock" v-model="category_cn_name"  filterable placeholder="全部" >
              <el-option
    ...
    <div class="col-nav">
      <ul>
        <li @click="add()"  ><span>增加</span></li>
        <li @click=""  ><span> 导入</span></li>
        <li @click=""  ><span> 批量设置WMS货品</span></li>
      </ul>
    </div>
    ...
    <div class="pDown">
      <el-table :data="tableData"
        ...
        <el-table-column label="操作" width="110" align='center'>
          <template slot-scope="scope">
            <div>
              <el-button @click="updateShop()" type="text" size="small">编 辑</el-button>
              <el-button   ref="del" type="text" size="small" style="color: red" @click="deleteShop(scope.row)">删 除</el-button>
            </div>
          </template>
        </el-table-column>
