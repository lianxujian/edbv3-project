  ...
  <div id="addWave">
    ...
    <div class="pTop">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>添加波次策咯</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!--主体-->
    <div class="content">
      ...
      <div class="conMid">
        ...
        <div class="midCon">
                  ...
                  <div class="pDown">
                    <el-table :data="tableDataExpress" border style="width: 950px">
                      ...
                      <el-table-column label="操 作" width="200">
                        <template slot-scope="scope">
                          <p class="cen-g">
                            <span @click="handleExpressDelete(scope.row,scope.$index, tableDataExpress)" style="color: red;cursor: pointer">删除</span>
                          </p>
                        </template>
                      </el-table-column>
                      ...
                      <el-table-column label="所属店铺" width="300">
                        <template slot-scope="scope">
                          ...
                          <el-dialog v-dialogDrag title="请选择指定店铺" :visible.sync="shopFormVisible" width="400px">
                            <ul style="overflow: auto;max-height: 300px">
                              <li style="width: 50%;float: left" v-for="(val,n) in shopForm" :title="val.storeName">
          ...
          <div class="orderWave">
            <span>大宗订单波次：</span>
            <span>单订单商品数量超过
              <input maxlength="4" ref="manySkuWaveEnd" v-model="manySkuWaveEnd" type="text" @keyup="manySkuWaveEnd = manySkuWaveEnd.replace(/[^\d]/g,'');if(manySkuWaveEnd == 0)manySkuWaveEnd = ''" class="inpNum-g">
...
//      }.bind(this);
    ...
    methods: {
      ...
      initTime: function () {
        ...
        this.executeStartTime = new Date(timeStart);
        let timeEnd = Y + ' ' + M + ' ' + D + ' 23:59:59';
        this.executeEndTime = new Date(timeEnd)
      },
      ...
      //表格里结束数值验证--提示信息
      testGoodsEndQty: function (event,row,index,data) {
        ...
        this._post('com.edb01.erp.wms.service.api.ExpressService/' + this.version + '/listExpress')
          .then(function (res) {
            if(res.data.success) {
              ...
              this.expressForm.forEach(function (val) {
                val.disabled = false
              });
              let obj = this.expressForm[index];
              obj.disabled = val.disabled;
              this.$set(this.expressForm,index,obj)
            }else {
              this.$message({
                message: res.data.msg,
                type: 'warning'
      ...
      initHold: function () {
        ...
        this._post('com.edb01.erp.wms.service.api.WmWaveStrategyService/' + this.version + '/saveWmWaveStrategyBean',data)
          .then(function (res) {
            if(res.data.success) {
//              this.$router.push('/wave')
      ...
      //快递删除
      handleExpressDelete: function (row,index, rows) {
      ...
      handleOrderClick: function (index) {
        ...
        if(this.typeForm.length == 0) {
          this.typeForm = [
            {id: 1,typeName: '正常订单',disabled: false},
            {id: 2,typeName: '预售订单',disabled: false},
            {id: 3,typeName: '换货订单',disabled: false},
            {id: 4,typeName: '补发订单',disabled: false},
            {id: 5,typeName: '定金订单',disabled: false}
          ];
        }else {
      ...
      //点击返回
      backClick: function () {
        console.log(this.executeStartTime);
//        this.$router.push('/wave')
...
<style>
  ...
  #addWave .el-dialog__body {
    padding: 30px 40px 0 !important;
  }
  #addWave .el-checkbox__label{
    width: 130px;
    overflow: hidden;
    white-space: nowrap;
