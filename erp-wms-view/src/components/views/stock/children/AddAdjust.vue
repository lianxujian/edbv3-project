  ...
  <div id="addAdjust">
    ...
    <div class="pTop">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>新增调整单</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!--搜索区-->
    <div id="searchBox">
      <el-row>
        <el-col :span="6">
          <div class="grid-content">
            ...
            <el-select @change="stockChange(storageId)" id="searchStock" v-model="storageId" filterable placeholder="请选择仓库">
              <el-option
        ...
        <el-col :span="6">
          <div class="grid-content">
            ...
            <el-select id="adjustType" v-model="invaType" filterable placeholder="请选择调整类型">
              <el-option
            ...
            <el-row>
              ...
              <el-col :span="10">
                <div class="grid-content">
                  ...
                  <el-input @keyup.enter.native="searchDialog" maxlength="50" style="width: 220px!important;" v-model="select1ValueDialog" placeholder=""></el-input>
                </div>
              </el-col>
              ...
              <el-col :span="7">
                <div class="grid-content">
                  ...
                  <el-input @keyup.enter.native="searchDialog" maxlength="100" id="name" v-model="goodsNameDialog" placeholder="请输入内容"></el-input>
                </div>
              </el-col>
  ...
  export default {
    ...
    methods:{
      ...
      initHold: function () {
        ...
        this._post('com.edb01.erp.wms.service.api.WmStockInvaService/' + this.version + '/insert',data)
          .then(function (res) {
            if(res.data.success) {
      ...
      stockChange: function (val) {
        this.stockArr.push(val);
        if(this.stockArgs != 1 && this.tableData.length != 0) {
          this.$confirm('切换仓库，商品数据将会清空，是否确定切换?', '提示', {
            ...
            this.stockArr = this.stockArr.slice(this.stockArr.length -2,this.stockArr.length -1);
            this.storageId = this.stockArr[0];
          });
        }
        this.stockArgs = 2
      ...
      deleteClick: function (row,index,rows) {
        if(row.stockInvaItemId == undefined) {
          rows.splice(index,1)
        }else {
          this.initDelete(row)
        }
...
<style>
  #addAdjust .el-textarea{
    width: 82%;
  }
  #addAdjust .el-table .cell {
    text-align: center;
  }
</style>
