  ...
  <div id="storageBill">
    ...
    <div class="pTop">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item><a @click="showParentBlock">仓库库存查询</a></el-breadcrumb-item>
    ...
    <div style="height: 40px;line-height: 40px;padding-left: 10px;">
      ...
      <span style="margin-left: 100px">仓库：{{ storageName }}</span>
    </div>
        ...
        <el-table-column label="操作" v-if="isShow" align="center">
          <template slot-scope="scope">
            <el-button
              ...
              type="text"
              size="small">
              <a href="javascript" v-if="scope.row.orderType == 1 && authorityCode.WMS_STORAGESTOCK_CAMPON">解除预占</a>
            </el-button>
          </template>
        </el-table-column>
