...
//====获取LODOP对象的主过程：====
export function getLodop(oOBJECT, oEMBED,fouceLodop) {
  fouceLodop = fouceLodop == undefined ? false : fouceLodop;
  ...
  try {
    ...
    if (fouceLodop == false && needCLodop()) {
      try {
        LODOP = getCLodop();
      } catch (err) {
      };
      ...
      if (oOBJECT != undefined || oEMBED != undefined) {
        ...
        LODOP.setAttribute("style", "position:absolute;left:0px;top:100px;width:100px;height:100px;");
