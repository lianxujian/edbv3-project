      ...
      >
        ...
        <span slot="footer" class="dialog-footer">
          <div style="text-align: right;width: 100%">
             <el-button type="small" @click="phone = false">取 消</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      savePhone() {
        ...
        self._post('com.edb01.upms.service.UserService/' + self.version + '/bindPhone',self.saveP)
          .then(function (res) {
            if (res.data.code == 0) {
              self.phone = false;
      ...
      acquirePhone() {
        ...
        self._post('com.edb01.upms.service.UserService/' + self.version + '/getValidationCode',self.verification)
          .then(function (res) {
            if (res.data.code == 0) {
    ...
    created() {
     /* if (localStorage.getItem('clToken')) {
      ...
      this.queryData = (par) => {
        var self = this;
        self._post('com.edb01.upms.service.UserAdminService/' + self.version + '/getCompanyUsers',par)
          .then(function (res) {
            if (res.data.code === 0) {
